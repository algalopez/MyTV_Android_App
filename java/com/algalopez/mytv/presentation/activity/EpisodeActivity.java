...
import com.algalopez.mytv.presentation.fragment.EpisodeFragment;

public class EpisodeActivity extends AppCompatActivity implements IActivity {

    private final static String LOGTAG = "EpisodeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setTypeface(tf);
        tv.setText(getResources().getString(R.string.activity_episode));
    ...
    public void setLocalToolbar() {
        ...
        favouriteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EpisodeFragment mainFragment = (EpisodeFragment) getSupportFragmentManager().findFragmentById(R.id.activity_episode_episodefragment);
