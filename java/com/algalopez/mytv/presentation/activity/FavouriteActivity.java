...
public class FavouriteActivity extends AppCompatActivity implements IActivity {

    private final static String LOGTAG = "FavouriteActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setTypeface(tf);
        tv.setText(getResources().getString(R.string.activity_favourites));
    ...
    protected void onPause() {
        super.onPause();
        if (mOverflowDialog!=null && mOverflowDialog.isShowing()){
        ...
        switch (entity.getAction()){
            case SHOW:
                if (mTwoPanes){
                    ...
                    args.putString(ShowActivity.PARAM_SEASON, "");
